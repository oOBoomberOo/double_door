execute if entity @s[tag=boomber.double_door.iron_door] run function boomber:double_door/iron_door/main
execute if entity @s[tag=boomber.double_door.oak_door] run function boomber:double_door/oak_door/main
